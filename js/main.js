  ...
  var baseURL = '//api.yummly.com/v1/api/recipes?_app_id='+apiID+'&_app_key='+apiKey+'&q=Main%20Dishes&allowedCuisine%5B%5D=cuisine%5Ecuisine-';
...
$(document).on('click', '#sub', function(event) {
  ...
  var url="//api.yummly.com/v1/api/recipes?_app_id=5d0de430&_app_key=e854c40c98b9131e8685322b1db966c5&allowedAllergy[]="+diet+"&allowedCuisine[]="+cuisine+"&maxResult=50&start=0"; 
  console.log(url);
  var choices = [];
  $.get(url, function(response){
        ...
        var newURL="//api.yummly.com/v1/api/recipe/";
        var j = 0;
        for(var x=0; x<3; x++){  
