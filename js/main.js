  ...
  function dietAppender(){
    ...
    $(".diet").append("<li><button type='button' class='btn'>"+currentValue .shortDescription+"</button></li>");
    });
  }
  function cuisineAppender(){
    cuisines.forEach(function(currentValue, index, array){
    $(".cuisine").append("<localesAvailableIn><button type='button' class='btn'>"+currentValue.description+"</button></li>");
    });
  }
/*
 diets.forEach(function(currentValue, index, array){
