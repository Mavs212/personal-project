  ...
  function dietAppender(){
    ...
    $(".diet").append("<li><button type='button' class='btn-group-xs'>"+currentValue .shortDescription+"</button></li>");
    });
  }
  function cuisineAppender(){
    cuisines.forEach(function(currentValue, index, array){
    $(".cuisine").append("<li><button type='button' class='btn-group-xs'>"+currentValue.description+"</button></li>");
    });
  }
/*
 diets.forEach(function(currentValue, index, array){
...
$('.diet .btn-group-xs').click(function() {
    $(this).toggleClass('clicked');
  
});

$('.cuisine .btn-group-xs').click(function() {
